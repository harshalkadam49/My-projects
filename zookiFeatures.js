...
import "./style.css";
import ourFeaturesImage from "./Images/ourFeaturesImage.png";
import performanceBackground from "./Images/performanceBackground.png"
      ...
      <div className="container">
        ...
        <div className="row align-items-center">
          ...
          {/* <img className="z-index-1 backgroundImages" src={performanceBackground}></img> */}
            ...
            <img className="" src={ourFeaturesImage}></img>
          </div>
        </div>
      </div>
    </div>
